...
def kruskal_mst(nodes, edges):
    ...
    print("\nPaso a paso del algoritmo de Kruskal (mínimo costo):\n")
    edges_sorted = sorted(edges, key=lambda x: x[2])  # ordena por peso
    ...
    print("Árbol de expansión mínimo completo:")
